...
RSpec.describe Merchant, type: :model do
  ...
  describe '.total_revenue_for_a_merchant_for_date' do
    it 'should return the total revenue for one merchant accross successful transactions on a date' do
      ...
      invoice_id_2 = create(:invoice, merchant_id: merchant.id, customer_id: customer_1.id, updated_at: date).id
      ...
      expect(Merchant.total_revenue_for_a_merchant_on_date(date, merchant.id)).to eq(10)
    end
  end
