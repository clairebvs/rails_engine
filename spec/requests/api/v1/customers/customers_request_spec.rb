...
describe 'Customers API' do
  ...
  it 'can find all customers by params updated at' do
    customer_1 = create(:customer, updated_at: '09-12-2018')
    customer_2 = create(:customer, updated_at: '04-02-2018')
    customer_3 = create(:customer, updated_at: '04-02-2018')

    get '/api/v1/customers/find_all?updated_at=04-02-2018'
